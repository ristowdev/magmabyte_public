...
export default function MagmabyteTable2(props: IMagmabyteTableProps) {
    const {
        columns
    } = props;
                        ...
                        <>
                            <tr>
                                <td data-column="image">
                                    <img 
                                        src={`${IMAGE_URL+col.article_thumbnail}`} 
                                        style={{
                                            width:'100px',
                                            height:'50px',
                                            objectFit:'cover'
                                ...
                                <td data-column="Title">{(col.article_name as string).substring(0, 50)+"..."}</td>
                                {/* <td data-column="Title">{col.article_status}</td> */}
                                <td data-column="Actions">
                                    <div style={{display:'flex'}}>
                                        <Link to={`/blog/article/${col._id}`} className='d-2--ed-ds-'>
                                            <EditActionButton>
                                                <FiEdit2 
                                                    size={16}
                                                    color='#00a7ff'
